      ...
      <div className="container">
        <div className="about-wrapper">
          ...
          <div className="about-text-side">
            ...
            <p className="about-desc">
              আমাদের অত্যাধুনিক ফাইবার অপটিক নেটওয়ার্কের মাধ্যমে আমরা খিলবাড়িরটেক, নূরেরচালা, বউ বাজার, শাহজাহাদপুর, বাঁশতলা, জে-ব্লক, আব্দুল্লাহবাগ সহ ভাটারার বিভিন্ন এলাকায় সর্বোচ্চ গতির ইন্টারনেট সেবা প্রদান করে আসছি।
            </p>
